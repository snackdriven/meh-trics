...
export namespace task {
  export class ServiceClient {
    ...
    public async deleteCalendarEvent(params: { id: number }): Promise<void> {
      await this.baseClient.callTypedAPI(`/calendar-events/${encodeURIComponent(params.id)}`, {
        method: "DELETE",
        body: undefined,
      });
    }
    ...
    public async deleteHabit(params: { id: number }): Promise<void> {
      await this.baseClient.callTypedAPI(`/habits/${encodeURIComponent(params.id)}`, {
        method: "DELETE",
        body: undefined,
      });
    }
    ...
    public async deleteRecurringTask(params: { id: number }): Promise<void> {
      await this.baseClient.callTypedAPI(`/recurring-tasks/${encodeURIComponent(params.id)}`, {
        method: "DELETE",
        body: undefined,
      });
    }
    ...
    public async deleteTask(params: { id: number }): Promise<void> {
      await this.baseClient.callTypedAPI(`/tasks/${encodeURIComponent(params.id)}`, {
        method: "DELETE",
        body: undefined,
      });
    }
    ...
    > {
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(
        `/journal-entries/${encodeURIComponent(params.date)}`,
        { method: "GET", body: undefined }
      );
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
    ...
    public async listCalendarEvents(
      params: RequestType<typeof api_task_list_calendar_events_listCalendarEvents>
    ): Promise<ResponseType<typeof api_task_list_calendar_events_listCalendarEvents>> {
    ...
    ): Promise<ResponseType<typeof api_task_list_habit_entries_listHabitEntries>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        endDate: params.endDate,
    ...
    public async listJournalEntries(
      params: RequestType<typeof api_task_list_journal_entries_listJournalEntries>
    ): Promise<ResponseType<typeof api_task_list_journal_entries_listJournalEntries>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        endDate: params.endDate,
    ...
    ): Promise<ResponseType<typeof api_task_list_mood_entries_listMoodEntries>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        endDate: params.endDate,
        startDate: params.startDate,
    ...
    public async listRoutineEntries(
      params: RequestType<typeof api_task_list_routine_entries_listRoutineEntries>
    ): Promise<ResponseType<typeof api_task_list_routine_entries_listRoutineEntries>> {
      // Convert our params into the objects we need for the request
      const query = makeRecord<string, string | string[]>({
        date: params.date,
        endDate: params.endDate,
    ...
    public async updateCalendarEvent(
      params: RequestType<typeof api_task_update_calendar_event_updateCalendarEvent>
    ): Promise<ResponseType<typeof api_task_update_calendar_event_updateCalendarEvent>> {
    ...
    public async updateHabit(
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/habits/${encodeURIComponent(params.id)}`, {
        method: "PUT",
    ...
    public async updateRecurringTask(
      params: RequestType<typeof api_task_update_recurring_task_updateRecurringTask>
    ): Promise<ResponseType<typeof api_task_update_recurring_task_updateRecurringTask>> {
      // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
      const body: Record<string, any> = {
        description: params.description,
        energyLevel: params.energyLevel,
    ...
    public async updateTask(
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callTypedAPI(`/tasks/${encodeURIComponent(params.id)}`, {
        method: "PUT",
        body: JSON.stringify(body),
      });
      return JSON.parse(await resp.text(), dateReviver) as ResponseType<
...
type RequestType<Type extends (...args: any[]) => any> = Parameters<Type> extends [
  infer H,
  ...any[],
]
  ? OmitCookie<H>
