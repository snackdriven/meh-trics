    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="p-6 space-y-3 bg-[var(--color-background-secondary)] rounded-xl border">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="flex items-start gap-3 p-4 bg-[var(--color-background-secondary)] rounded-lg border">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="flex items-center justify-between p-3 bg-[var(--color-background-secondary)] rounded border">
