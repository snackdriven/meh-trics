 ...
 */
export function createOptimizedContext<T, Actions extends Record<string, (...args: any[]) => void>>() {
...
export const todaySelectors = {
  ...
  habitById: (habitId: number) => (state: any) => 
    state.habits?.find((h: any) => h.id === habitId),
