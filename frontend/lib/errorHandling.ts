...
const ERROR_MESSAGES: Record<string, string> = {
  RESOURCE_NOT_FOUND: "We couldn't find what you're looking for. It may have been deleted or moved.",
  ...
  RECURRING_TASK_LIMIT_EXCEEDED: "You've reached the limit for this recurring task this cycle. Try again next cycle.",
  HABIT_ALREADY_LOGGED: "You've already logged this habit for today. You can update your existing entry instead.",
  JOURNAL_ENTRY_CONFLICT: "There's a conflict with your journal entry. Please refresh and try again.",
  DATABASE_CONNECTION_ERROR: "We're having trouble connecting to our servers. Please try again in a moment.",
  DATABASE_CONSTRAINT_VIOLATION: "This action would violate data integrity rules. Please check your input.",
  DATABASE_TRANSACTION_FAILED: "We couldn't complete your request. Please try again.",
  CALENDAR_IMPORT_FAILED: "We couldn't import your calendar file. Please check the format and try again.",
  INTERNAL_SERVER_ERROR: "Something went wrong on our end. We're looking into it. Please try again later.",
  SERVICE_UNAVAILABLE: "This feature is temporarily unavailable. Please try again in a few minutes.",
};
